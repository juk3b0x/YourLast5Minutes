    ...
    for x = 0, 127 do
        for y = 0, 63 do
            ...
            elseif value >= 6 and value < 8 then
                ...
                if get_grid_same_neighbors(x, y) == 1 then
                    col = 20 --colors[5]
                elseif get_grid_same_neighbors(x, y) == 2 then
                    col = 36 --colors[5]
                elseif get_grid_same_neighbors(x, y) >= 3 then
                    col = 52 --colors[5]
                else
                    col = 4 --colors[4]
                end
...
function get_grid_same_neighbors(x, y)
    local value = get_level(x, y)
    local neighbors = 0
...
888088888888088888888888888888888888888888888888000000000000000000000000000000000000000033f77733333b3b33b33333b33333333333555533
...

